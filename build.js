...
// The phone number appears in markup only as contact.direct, scrambled
// (reversed, digits rotated by 5) — script.js descrambles it on click
// (see .phone-reveal), so bots scraping the page never see the number
const phoneData = esc(contact.direct || '');
          ...
          <div class="contact-info fade-in slide-right">
            ...
            <div class="contact-detail">
              ...
              <div>
                ...
                <a href="#" class="contact-value phone-reveal" data-d="${phoneData}">Click to Reveal Phone Number</a>
              </div>
            </div>
            <div class="contact-detail">
      ...
      <div class="container">
        <div class="footer-content">
          ...
          <div class="footer-contact">
            <a href="#" class="phone-reveal" data-d="${phoneData}">Click to Reveal Phone Number</a>
