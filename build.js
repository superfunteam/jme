...
const testimonialSlides = testimonials.map((t, i) => {
  ...
  return `                <div class="testimonial${i === 0 ? ' active' : ''}" data-index="${i}" data-adlib-each="testimonials" data-adlib-index="${i}">
                  <blockquote>
                    <p data-adlib-cms="testimonials.${i}.quote">&ldquo;${esc(t.quote)}&rdquo;</p>
                  </blockquote>
...
const pillarsHTML = approach.pillars.map((p, i) =>
  `          <div class="pillar fade-in scale-in" data-adlib-each="approach.pillars" data-adlib-index="${i}">
            ...
            <p data-adlib-cms="approach.pillars.${i}.description">${esc(p.description)}</p>
          </div>`
).join('\n');
  ...
  return `
          <div class="service-row fade-in" data-service data-adlib-each="services" data-adlib-index="${i}">
            ...
            <div class="service-content">
              ...
              <p class="service-description" data-adlib-cms="services.${i}.description">${esc(s.description)}</p>
...
${marqueeHTML}
    ...
    <section id="mission" class="section mission-section" data-adlib-section="mission">
      ...
      <div class="container">
        ...
        <p class="mission-lead text-reveal" data-adlib-cms="mission.lead">${esc(mission.lead)}</p>

        <div class="mission-body fade-in slide-right">
          <p data-adlib-cms="mission.body.0">${esc(mission.body[0])}</p>
          <p data-adlib-cms="mission.body.1">${esc(mission.body[1])}</p>
        </div>
        <div class="stats-row">
${statsHTML}
        </div>
      ...
      <div class="container">
        ...
        <div class="approach-header">
          <div class="approach-title-block fade-in slide-right">
            ...
            <p class="approach-intro" data-adlib-cms="approach.intro">${esc(approach.intro)}</p>
          </div>
      ...
      <div class="container">
        ...
        <div class="about-layout">
          ...
          <div class="about-text-col">
            ...
            <p class="about-lead fade-in" data-adlib-cms="about.lead">${esc(about.lead)}</p>
      ...
      <div class="container">
        ...
        <div class="contact-content">
          ...
          <div class="contact-info fade-in slide-right">
            <p class="contact-intro" data-adlib-cms="contact.intro">${esc(contact.intro)}</p>
